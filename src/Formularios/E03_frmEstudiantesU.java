 ...
 */
public class E03_frmEstudiantesU extends javax.swing.JFrame {

    /**
     * Creates new form E03_frmEstudiantesU
     */
    public E03_frmEstudiantesU() {
        initComponents();
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        E03_frm_EditEstudiantesU frm = new E03_frm_EditEstudiantesU("Insertar");
        frm.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTable1.getSelectedRow() >= 0) {
            ...
            int pos = E03_TLista.Buscar(Codigo);
            E03_EstudiantesU es = E03_TLista.getEstudiantes(pos);
            E03_frm_EditEstudiantesU frm = new E03_frm_EditEstudiantesU("Modificar");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        E03_TLista.CalcularRequisitos();
    }//GEN-LAST:event_jButton4ActionPerformed

    public static void CargarDatos() {
        E03_TLista.Insertar(new E03_EstudiantesU(1, 798, 10.00));
        E03_TLista.Insertar(new E03_EstudiantesU(2, 538, 9.00));
        E03_TLista.Insertar(new E03_EstudiantesU(3, 956, 8.99));
        E03_TLista.Insertar(new E03_EstudiantesU(1, 141, 5.60));
        E03_TLista.Insertar(new E03_EstudiantesU(2, 751, 9.50));
        E03_TLista.Insertar(new E03_EstudiantesU(3, 771, 7.00));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E03_frmEstudiantesU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new E03_frmEstudiantesU().setVisible(true);
            }
        });
    }
