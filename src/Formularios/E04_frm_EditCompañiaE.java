 ...
 */
public class E04_frm_EditCompañiaE extends javax.swing.JFrame {
    ...
    public E04_frm_EditCompañiaE(String fun) {
        this.Funcion = fun;
        initComponents();
        setResizable(false);
    ...
    public void SetDatos(E04_CompañiaE co) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField1.getText().equals("") && !jTextField1.getText().equals("") && !jTextField1.getText().equals("")
            ...
            E04_CompañiaE co = new E04_CompañiaE(Zona, Numero_cliente, LMMAnterior, LMMActual);
            if (Funcion.equals("Insertar")) {
                E04_TLista.Insertar(co);
            }
            if (Funcion.equals("Modificar")) {
                E04_TLista.Editar(co, E04_TLista.Buscar(Zona));
            }
            E04_frmCompañiaE.ListarCompañia();
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E04_frm_EditCompañiaE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new E04_frm_EditCompañiaE("").setVisible(true);
            }
        });
    }
